        ...
        <div className="flex flex-1 flex-col px-6 pb-8 sm:px-10 lg:w-[54%]">
          ...
          <form onSubmit={send} className="flex items-center gap-2">
            <input
              ...
              aria-label="Message"
              className="flex-1 rounded-full border border-white/15 bg-white/[0.04] px-5 py-3 text-sm text-zinc-100 outline-none transition placeholder:text-zinc-500 focus:border-white/35"
            />
            <button
              type="submit"
              disabled={!draft.trim()}
